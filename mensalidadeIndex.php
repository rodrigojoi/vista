...
<div class="container-fluid bg2 text-center" id="div-formacoes">
  <h3>Mensalidades - Escolha um Contrato </h3>
  <hr />
        ...
        if(isset($vetorContrato)) {
          ...
          ?>
            <tr>
              ...
              <td>  
                <a href='mensalidadeAlterar.php?contratoCodigo=<?php echo $codigo;?>'><i class='bi bi-card-checklist' title='Ver Mensalidades'></i></a>
              </td>
            </tr>
          <?php
          }
